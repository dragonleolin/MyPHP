...
<?php include __DIR__ . '/__html_head.php' ?>
                ...
                <form>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="cate1" name="cate1">
                            ...
                            <option value="<?= $a1['sid'] ?>" <?= $a1['sid']==$cate1_preset ? 'selected' : '' ?>>
                                <?= $a1['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="cate2" name="cate2" data-val="<?= $cate2_preset ?>">
                        </select>
                    </div>
                </form>
            </div>
    ...
    <script>
        ...
        cate2.value = cate2.getAttribute('data-val');
